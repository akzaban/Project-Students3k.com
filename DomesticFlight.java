...
public class Ttrain extends JFrame
{
	...
	public Ttrain(LoginPage type1)
	{
		...
		BFindTrain = new JButton("Find Flight");
		...
		BFindTrain.setBounds(50,270,100,25);
		...
		BFindTrain.addActionListener(new button3(this, type1));
	}
...
class button3 implements ActionListener
{
	Ttrain type;
	LoginPage type1;
	button3(Ttrain type, LoginPage type1)
	{
		this.type = type;
		this.type1 = type1;
	}
