...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LDemo = new JLabel("<html><U><font color=\"#8FBC8F\">Railway-Project Developed By</font></U></html>");
		JLabel Akanksha=new JLabel("<html><I><font color=\"#8FBC8F\">Akanksha Banthwan</font></I></html>");
		JLabel Anjali=new JLabel("<html><I><font color=\"#8FBC8F\">Anjali Srivastava</font></I></html>");
		JLabel Shubhangi=new JLabel("<html><I><font color=\"#8FBC8F\">Shubhangi Kori</font></I></html>");
		...
		Akanksha.setBounds(285,485,300,20);
		Anjali.setBounds(285,505,300,20);
		Shubhangi.setBounds(285,525,300,20);
